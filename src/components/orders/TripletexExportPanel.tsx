...
export function TripletexExportPanel({
  ...
  const defaultFields = useMemo((): ExportField[] => {
    ...
    const onsket_utfort_dato = values.onsket_utfort_dato || "";
    ...
    const bestillingtype = values.bestillingtype || "";
    ...
    return [
      ...
      { key: "projektnummer", label: "Projektnummer", tripletexColumn: "Projektnummer", value: "", required: false },
      { key: "startdato", label: "Startdato", tripletexColumn: "Startdato", value: onsket_utfort_dato || format(new Date(), "yyyy-MM-dd"), required: false },
      ...
      { key: "internprosjekt", label: "Internprosjekt", tripletexColumn: "Internprosjekt", value: bestillingtype === "intern" ? "Ja" : "Nei", required: false },
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent className="w-full sm:max-w-lg overflow-y-auto">
        <SheetHeader>
          <SheetTitle>Eksporterer til Tripletex</SheetTitle>
          <SheetDescription>
