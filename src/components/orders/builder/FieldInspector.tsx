...
export function FieldInspector({
      ...
      <div className="h-full flex items-center justify-center p-6">
        <div className="text-center">
          ...
          <p className="text-xs text-muted-foreground">
            Velg et felt eller en seksjon for å redigere egenskaper
          </p>
        </div>
      </div>
    );
        ...
        <div className="p-3 space-y-3">
          <div>
            ...
            <Input
              ...
              onChange={(e) =>
                setLocalSection((p) => ({ ...p, title: e.target.value }))
              }
              onBlur={() =>
                onUpdateSection(section.id, { title: localSection.title })
              }
            ...
            <Textarea
              ...
              onBlur={() =>
                onUpdateSection(section.id, {
                  description: localSection.description || null,
                })
              }
          ...
          <div className="flex items-center justify-between">
            ...
            <Switch
              ...
              onCheckedChange={(v) =>
                onUpdateSection(section.id, { is_active: v })
              }
            />
          </div>
          <Separator />
  ...
  const optionsText = Array.isArray(localField.options)
      ...
      <div className="p-3 border-b border-border">
        <div className="flex items-center justify-between">
          ...
          <Badge variant="outline" className="text-[9px]">
            {ORDER_FIELD_TYPE_LABELS[field.field_type as OrderFormFieldType] ||
              field.field_type}
          </Badge>
        </div>
      </div>
      <div className="p-3 space-y-3">
        <div>
          ...
          <Input
            ...
            onChange={(e) =>
              setLocalField((p) => ({ ...p, label: e.target.value }))
            }
        ...
        <div>
          ...
          <Input
            ...
            onChange={(e) =>
              setLocalField((p) => ({ ...p, field_key: e.target.value }))
            }
            onBlur={() =>
              saveField({ field_key: localField.field_key })
            }
        ...
        <div>
          ...
          <Textarea
            ...
            onChange={(e) =>
              setLocalField((p) => ({ ...p, help_text: e.target.value }))
            }
            onBlur={() =>
              saveField({
                help_text: localField.help_text || null,
              })
            }
        ...
        <div>
          ...
          <Input
            ...
            onBlur={() =>
              saveField({
                placeholder: localField.placeholder || null,
              })
            }
            className="h-8 text-sm"
          />
        ...
        <div>
          ...
          <p className="text-[10px] text-muted-foreground mt-1">
            Feltene med halv bredde plasseres side om side i skjemaet.
          </p>
        </div>
          ...
          <>
            ...
            <div className="rounded-lg bg-muted/30 p-2.5 text-xs text-muted-foreground space-y-1.5">
              ...
              {field.field_type === "customer_lookup" && (
                <p>
                  Lar brukeren velge en eksisterende kunde fra systemet. Kan
                  autofylle kundenavn, org.nr, adresse og kontaktinfo i andre
                  felt.
                </p>
              )}
              {field.field_type === "project_lookup" && (
                <p>
                  Lar brukeren koble bestillingen til et eksisterende prosjekt.
                  Prosjektdata kan brukes videre i behandlingen.
                </p>
              )}
              {field.field_type === "user_lookup" && (
                <p>
                  Lar brukeren velge en intern bruker, f.eks. ansvarlig
                  kontaktperson eller prosjektleder.
                </p>
              )}
            </div>
          </>
        ...
        <div>
          ...
          <Input
            ...
            onBlur={() =>
              saveField({
                default_value: localField.default_value || null,
              })
            }
            className="h-8 text-sm"
          />
