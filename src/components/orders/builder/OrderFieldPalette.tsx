...
const BUSINESS_PRESETS: BusinessPreset[] = [
  ...
  { id: "fakturamarking", label: "Fakturamarking / PO", icon: FileText, fieldType: "short_text", fieldKey: "fakturamarking", helpText: "PO-nummer, referanse eller annen merking", fieldWidth: "half" },
  { id: "oppdragssteda", label: "Oppdragssted", icon: MapPin, fieldType: "short_text", fieldKey: "oppdragssteda", helpText: "Navn på anlegg eller oppdragssted", isRequired: true },
  ...
  { id: "arbeidsbeskrivelsa", label: "Arbeidsbeskrivelse", icon: ClipboardList, fieldType: "long_text", fieldKey: "arbeidsbeskrivelsa", helpText: "Beskriv hva som skal utføres så detaljert som mulig", isRequired: true },
  { id: "materialansvar", label: "Materialansvar", icon: Package, fieldType: "radio", fieldKey: "materialansvar", helpText: "Angir hvem som skaffer materiell", options: ["Service skaffer alt", "Bestiller leverer alt", "Deles mellom partene"], isRequired: true },
...
const FIELD_BLOCKS: FieldBlock[] = [
  {
    ...
    fields: [
      ...
      { label: "Bestiller – E-post", type: "email", field_key: "bestiller_epost", is_required: true, help_text: "Denne e-postadressen mottar oppdateringer om bestilling", field_width: "half" },
  ...
  },
  {
    ...
    fields: [
      ...
      { label: "Fakturamarking / PO", type: "short_text", field_key: "fakturamarking", help_text: "PO-nummer, referanse eller annen merking", field_width: "half" },
  ...
  },
  {
    ...
    previewLayout: "full",
    fields: [
      { label: "Oppdragssted", type: "short_text", field_key: "oppdragssteda", is_required: true, help_text: "Navn på anlegg eller oppdragssted" },
  ...
  },
  {
    ...
    previewLayout: "full",
    fields: [
      { label: "Hvem skaffer materiell?", type: "radio", field_key: "materialansvar", is_required: true, options: ["Service skaffer alt", "Bestiller leverer alt", "Deles mellom partene"], help_text: "Angir tydelig materialansvar" },
      { label: "Hva leverer bestiller / kunde?", type: "long_text", field_key: "hva_leverer_bestiller", help_text: "Beskriv hva bestiller/kunde leverer av materiale" },
      { label: "Hva må service skaffe?", type: "long_text", field_key: "hva_skaffar_service", help_text: "Beskriv hva service må skaffe" },
    ],
  },
  {
  ...
  {
    id: "internal_kontroll", label: "Intern kontroll", icon: FileCheck,
...
const GENERIC_FIELDS: GenericFieldDef[] = [
  ...
  { type: "long_text", label: "Lang tekst", description: "Flerlinjers tekstfelt", icon: AlignLeft },
  ...
  { type: "radio", label: "Radioknapper", description: "Velg ett synlig val", icon: CircleDot },
  ...
  { type: "multi_select", label: "Fleirval", description: "Velg flere fra liste", icon: ListChecks },
