...
export function CatalogSettingsDialog({
  ...
  const [form, setForm] = useState({
    ...
    subtitle:
      "Velg riktig kategori og skjema for å sende inn en bestilling, melding eller forespørsel.",
    help_text: "",
    contact_info: "",
  });

  const { data: settings } = useQuery({
    queryKey: ["catalog-settings", tenantId],
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <Textarea
              ...
              onChange={(e) =>
                setForm((p) => ({ ...p, help_text: e.target.value }))
              }
              rows={2}
          ...
          <div>
            ...
            <Input
              ...
              onChange={(e) =>
                setForm((p) => ({ ...p, contact_info: e.target.value }))
              }
