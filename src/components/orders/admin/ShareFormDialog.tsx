          ...
          <TabsContent value="script" className="space-y-3 mt-3">
            <div>
              ...
              <p className="text-[11px] text-muted-foreground mt-2">
                Scriptet opprettter en iframe som automatisk justerer høyden etter innholdet.
            ...
            <div className="text-xs text-muted-foreground">
              ...
              <p className="mt-0.5">
                {template.requires_login
                  ...
                  : "Skjemaet er kun tilgjengelig internt. Endre målgruppe til ekstern eller begge for å aktivere embedding."}
              </p>
            </div>
          </div>
        )}
