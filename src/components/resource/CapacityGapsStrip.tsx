      ...
      <div className="flex items-center gap-1.5 flex-wrap">
        ...
        {visibleGaps.map((gap) => (
          ...
          >
            ...
            <span className="font-medium truncate max-w-[120px]">{gap.techName.split(" ")[0]}</span>
            <span>{format(gap.date, "EEE", { locale: nb })} {fmtHour(gap.startHour)}–{fmtHour(gap.endHour)}</span>
